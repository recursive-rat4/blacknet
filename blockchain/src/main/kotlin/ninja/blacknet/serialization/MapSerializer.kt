 ...
 */
public abstract class MapSerializer<T : MutableMap<K, V>, K, V> : KSerializer<T> {
    protected abstract val keySerializer: KSerializer<K>
    protected abstract val valueSerializer: KSerializer<V>
