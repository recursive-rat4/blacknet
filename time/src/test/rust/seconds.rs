...
#[test]
fn literate() {
    assert_eq!(Seconds::with_minutes(4), Seconds::from(4 * 60));
    assert_eq!(Seconds::with_hours(4), Seconds::from(4 * 60 * 60));
    assert_eq!(Seconds::with_days(4), Seconds::from(4 * 24 * 60 * 60));
}
