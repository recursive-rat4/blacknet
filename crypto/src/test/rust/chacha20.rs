...
use blacknet_crypto::symmetric::ChaCha20;
...
fn rfc8439() {
    ...
    cipher.seek(1);
    cipher.encrypt(&mut scratch, &decrypted);
    assert_eq!(scratch, encrypted);
}

#[test]
fn blacknet() {
    let key: [u8; 32] = [
        0x81, 0xC7, 0x98, 0xD1, 0xCF, 0xAD, 0xB4, 0x4D, 0x9A, 0xD0, 0xF2, 0xD4, 0x12, 0x15, 0x26,
        0xA8, 0x20, 0x5C, 0xAE, 0x4C, 0x5F, 0x4A, 0xC6, 0x81, 0x7C, 0x93, 0xE6, 0x2D, 0x5C, 0xF9,
        0x2D, 0xFC,
    ];
    let iv: [u8; 12] = [
    ...
    let decrypted: [u8; 32] = [
        0xF7, 0xB7, 0xFE, 0xEC, 0xB8, 0x49, 0xA2, 0x7D, 0x6A, 0xBA, 0xB0, 0xD4, 0x50, 0x54, 0xA6,
        0xCA, 0x88, 0xCA, 0xDA, 0x11, 0xFF, 0x3B, 0xBF, 0xE6, 0x68, 0x69, 0x24, 0x8E, 0xF5, 0x56,
        0xE5, 0xC3,
    ];
    let encrypted: [u8; 32] = [
        0xEF, 0x9D, 0xD7, 0xB6, 0xDC, 0x19, 0x76, 0x80, 0x77, 0xE7, 0xAC, 0x4E, 0xD5, 0x3C, 0x04,
        0x6D, 0xA2, 0x7C, 0x64, 0xC5, 0x59, 0xC4, 0xAB, 0x9A, 0x0A, 0xA9, 0xDE, 0xC9, 0x75, 0xA5,
        0x0F, 0x66,
    ];
