...
struct Poseidon2PervushinParams {
    ...
    constexpr static const std::size_t r = 20;

    constexpr static const std::size_t rfb = 4;
    constexpr static const std::size_t rpe = 16;
    constexpr static const std::array<F, t*r> rc = std::array<PervushinRing, 240>{
        ...
        PervushinRing("0000000000000000"),
        PervushinRing("0000000000000000"),
        PervushinRing("0000000000000000"),
        PervushinRing("0000000000000000"),
        PervushinRing("0000000000000000"),
