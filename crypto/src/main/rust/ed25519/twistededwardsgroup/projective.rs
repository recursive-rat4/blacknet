...
impl<P: TwistedEdwardsGroupParams> Add<TwistedEdwardsGroupProjective<P>>
    for &TwistedEdwardsGroupProjective<P>
{
    type Output = TwistedEdwardsGroupProjective<P>;

    #[inline]
    fn add(self, rps: TwistedEdwardsGroupProjective<P>) -> Self::Output {
        *self + rps
    }
}

impl<'a, P: TwistedEdwardsGroupParams> Add<&'a TwistedEdwardsGroupProjective<P>>
    for &TwistedEdwardsGroupProjective<P>
{
    type Output = TwistedEdwardsGroupProjective<P>;

    #[inline]
    fn add(self, rps: &'a TwistedEdwardsGroupProjective<P>) -> Self::Output {
        *self + *rps
    }
}
...
impl<P: TwistedEdwardsGroupParams> Sub<TwistedEdwardsGroupProjective<P>>
    for &TwistedEdwardsGroupProjective<P>
{
    type Output = TwistedEdwardsGroupProjective<P>;

    #[inline]
    fn sub(self, rps: TwistedEdwardsGroupProjective<P>) -> Self::Output {
        *self - rps
    }
}

impl<'a, P: TwistedEdwardsGroupParams> Sub<&'a TwistedEdwardsGroupProjective<P>>
    for &TwistedEdwardsGroupProjective<P>
{
    type Output = TwistedEdwardsGroupProjective<P>;

    #[inline]
    fn sub(self, rps: &'a TwistedEdwardsGroupProjective<P>) -> Self::Output {
        *self - *rps
    }
}
...
impl<P: TwistedEdwardsGroupParams> Zero for TwistedEdwardsGroupProjective<P> {
...
impl<P: TwistedEdwardsGroupParams> BlSelect<TwistedEdwardsGroupProjective<P>>
    for &TwistedEdwardsGroupProjective<P>
where
    for<'a> &'a P::F: BlSelect<P::F, Output = P::F>,
{
    ...
    fn bl_select(self, rps: TwistedEdwardsGroupProjective<P>, condition: bool) -> Self::Output {
        Self::Output {
            x: (&self.x).bl_select(rps.x, condition),
            y: (&self.y).bl_select(rps.y, condition),
            z: (&self.z).bl_select(rps.z, condition),
...
impl<P: TwistedEdwardsGroupParams> BlSelect for &TwistedEdwardsGroupProjective<P>
where
