...
use crate::algebra::{AlgebraOps, RingOps, UnitalAlgebra, UnitalRing};
    ...
    for<'a> &'a A: AlgebraOps<R, A>,
{
    ...
    let c = &p1 * R::INV3_MUL2 - &p2 * R::INV24 + &n1 * R::INV3_MUL2
        - &n2 * R::INV24
        - &z0 * R::INV4_MUL5;
    ...
    for<'a> &'a A: AlgebraOps<R, A>,
{
    ...
    let c = &z0 * R::INV12_MUL5 - &p1 * R::INV12_MUL7 + &p2 * R::INV24_MUL7
        ...
        - &n1 * R::INV24
        - &n2 * R::INV24;
    let d = &p1 * R::INV3_MUL2 - &p2 * R::INV24 + &n1 * R::INV3_MUL2
        - &n2 * R::INV24
        - &z0 * R::INV4_MUL5;
