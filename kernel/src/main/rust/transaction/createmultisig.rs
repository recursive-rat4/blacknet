...
fn id(hash: Hash256, data_index: u32) -> MultiSignatureLockContractId {
...
impl CreateMultisig {
    ...
    fn hash(&self, from: PublicKey, seq: u32, data_index: u32) -> Result<Hash256> {
        let copy = Self {
            n: self.n,
