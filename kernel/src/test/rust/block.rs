...
fn serialization() {
    let deserialized = Block::with_all(
        ...
        Hash::ZERO,
        1545556624.into(),
        PublicKey::try_from("B7E64C1BC5ADD0593397E75E827A8DA323EA8C6E1FE6142A86092C9359117E50").unwrap(),
        Hash::try_from("45B0CFC220CEEC5B7C1C62C4D4193D38E4EBA48E8815729CE75F9C0AB0E4C1C0").unwrap(),
        Signature::try_from("0BD14B678ED7C9C5E44E4C2EF6307416B44CFE3315D17345DAF80EF60CD684A5AABDFD0DA0983ED1EC8B3797E49D89053BE49FA2149597FB3E14AAA48DE02505").unwrap(),
        Default::default(),
    );
