...
export var crypto_box_afternm = crypto_secretbox;
export var crypto_box_open_afternm = crypto_secretbox_open;
...
export function crypto_hash(out, m, n) {
  ...
  var hash = blake2b.blake2b(input, null, out.length);
...
export var crypto_secretbox_KEYBYTES = 32,
...
export var secretbox_keyLength = crypto_secretbox_KEYBYTES;
export var secretbox_nonceLength = crypto_secretbox_NONCEBYTES;
export var secretbox_overheadLength = crypto_secretbox_BOXZEROBYTES;
...
export var scalarMult_scalarLength = crypto_scalarmult_SCALARBYTES;
export var scalarMult_groupElementLength = crypto_scalarmult_BYTES;
...
export var box_publicKeyLength = crypto_box_PUBLICKEYBYTES;
export var box_secretKeyLength = crypto_box_SECRETKEYBYTES;
export var box_sharedKeyLength = crypto_box_BEFORENMBYTES;
export var box_nonceLength = crypto_box_NONCEBYTES;
export var box_overheadLength = secretbox_overheadLength;
...
export var sign_publicKeyLength = crypto_sign_PUBLICKEYBYTES;
export var sign_secretKeyLength = crypto_sign_SECRETKEYBYTES;
export var sign_seedLength = crypto_sign_SEEDBYTES;
export var sign_signatureLength = crypto_sign_BYTES;

export function hash(msg, outlen) {
  checkArrayTypes(msg);
  outlen = outlen || crypto_hash_BYTES;
  var h = new Uint8Array(outlen);
  crypto_hash(h, msg, msg.length);
  return h;
}

export var hash_hashLength = crypto_hash_BYTES;
